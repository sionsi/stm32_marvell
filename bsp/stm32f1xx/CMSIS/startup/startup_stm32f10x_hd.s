...
TASK_MAIN_STK_SIZE   EQU     1016

                AREA    STACK, NOINIT, READWRITE, ALIGN=3
Stack_Mem       SPACE   Stack_Size
__initial_sp

__initial_spTop EQU    0x20000800                 ; stack used for SystemInit_ExtMemCtl	BEFORE 400
...
Reset_Handler   PROC
                ...
                IMPORT  __main
				IMPORT  SystemInit
				;IMPORT   Task_Main_Stk

;                LDR     R0, = SystemInit_ExtMemCtl ; initialize external memory controller
;                BLX     R0

;                LDR     R1, =Task_Main_Stk        ; restore original stack pointer
;				ADD     R1, R1 ,#TASK_MAIN_STK_SIZE
;                MSR     MSP, R1                   
