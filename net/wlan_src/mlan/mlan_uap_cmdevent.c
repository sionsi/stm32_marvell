                      ...
                      IN mlan_ioctl_req * pioctl_buf)
{
    ...
    if (psnmp_mib->query_type == HostCmd_ACT_GEN_GET) {
        ...
        case Dot11D_i:
            ...
            pmpriv->state_11d.enable_11d = (state_11d_t) data;
            /* Set user enable flag if called from ioctl */
            if (pioctl_buf)
                pmpriv->state_11d.user_enable_11d = (state_11d_t) data;
            break;
        case Dot11H_i:
            data = wlan_le16_to_cpu(*((t_u16 *) (psnmp_mib->value)));
...
wlan_ops_uap_process_event(IN t_void * priv)
{
    ...
    case EVENT_RADAR_DETECTED:
        ...
        wlan_recv_event(pmpriv, pevent->event_id, pevent);
        pevent->event_id = (mlan_event_id) 0;   // clear to avoid resending at end of fcn
